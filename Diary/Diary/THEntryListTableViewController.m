//
//  THEntryListTableViewController.m
//  Diary
//
...
#import "THEntryListTableViewController.h"
#import "THCoreDataStack.h"
#import "THDiaryEntry.h"
#import "THEntryViewController.h"
#import "THEntryCell.h"

@interface THEntryListTableViewController () <NSFetchedResultsControllerDelegate>

@property (nonatomic, strong) NSFetchedResultsController *fetchedResultsController;

@end

@implementation THEntryListTableViewController
...
- (NSFetchedResultsController *) fetchedResultsController {
    ...
    THCoreDataStack *coreDataStack = [THCoreDataStack defaultStack];
    NSFetchRequest *fetchResquest = [self entryListFetchRequest];
    
    _fetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchResquest managedObjectContext: coreDataStack.managedObjectContext sectionNameKeyPath:@"body" cacheName:nil];
